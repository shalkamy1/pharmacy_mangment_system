                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./pateint/create _pateint.php">pateint</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="./doctors/create_doctors.php">Doctors</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="./employess/create_emplyees.php">employees</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="./suppliers/create_supplier.php">suppliers</a>
                            </li>
